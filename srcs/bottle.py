...
if __name__ == '__main__':
    ...
    _opt("-k", "--pem", default='', help="ssl pem file name.")
...
if __name__ == '__main__':
    ...
    run(args[0], host=host, port=int(port), server=opt.server,
        reloader=opt.reload, plugins=opt.plugin, debug=opt.debug, ssl_pem=opt.pem)
